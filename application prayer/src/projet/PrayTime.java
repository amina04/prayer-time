...
public class PrayTime {
	 ...
	 *
	 * fa : fajr angle ms : maghrib selector (0 = angle; 1 = minutes after sunset)
	 * mv : maghrib parameter value (in angle or minutes) is : isha selector (0 =
	 * angle; 1 = minutes after maghrib) iv : isha parameter value (in angle or
	 * minutes)
	 */
	...
	// return prayer times for a given date
	ArrayList<String> getPrayerTimes(Calendar date, double latitude, double longitude, double tZone) {
...
//        double latitude = 36.0848;
//        double longitude = 4.7848;
//        double timezone = 1;
